<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="typeName" label="类型名称" width="260"></el-table-column>
        ...
        <el-row>
          <el-col :span="24" v-if="form.parentId !== 0">
            <el-form-item label="上级类型" prop="parentId">
              <treeselect v-model="form.parentId" :options="typeOptions" :normalizer="normalizer" placeholder="选择上级类型" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="类型名称" prop="typeName">
...
<script>
import {listType, getType, delType, addType, updateType, listTypeExcludeChild} from "@/api/system/type";
